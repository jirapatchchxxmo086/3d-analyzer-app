...
# 2. ปรับแต่ง Font ผ่าน Sidebar (ถอดระบบธีมออกแล้ว)
...
# 3. โหลด Font Awesome Icons, Google Fonts และสั่งการ CSS (ใช้สีคลีนมาตรฐาน)
st.markdown(
    f"""
...
if uploaded_file is not None:
    with st.spinner("Processing 3D file..."):
        try:
            ...
            st.error(f"เกิดข้อผิดพลาดในการประมวลผล: {e}")import streamlit as st
import trimesh
