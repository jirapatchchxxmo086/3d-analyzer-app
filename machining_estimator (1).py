...
# ⚠️ ค่าเหล่านี้ "ไม่ได้มาจากตารางที่ส่งมา" (ตารางไม่มี print speed/layer height ของ 3D Print)
# เป็นค่ามาตรฐานอุตสาหกรรมทั่วไปชั่วคราว ต้องขอค่าจริงจากทีมมายืนยันก่อนใช้งานจริง
FDM_PRINT_DEFAULTS = {
